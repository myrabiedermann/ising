...
MainWindow::MainWindow(QWidget *parent) :
    ...
    averageMagnetisationChart(new ChartWidget()),
    ...
    ui(new Ui::MainWindow)
{
    ...
    {    
        ...
        QHBoxLayout* upperCentralAreaLayout = new QHBoxLayout;
        QHBoxLayout* lowerCentralAreaLayout = new QHBoxLayout;
        QVBoxLayout* chartLayout = new QVBoxLayout;
        Q_CHECK_PTR(mainLayout);
        Q_CHECK_PTR(CentralAreaLayout);
        Q_CHECK_PTR(upperCentralAreaLayout);
        Q_CHECK_PTR(lowerCentralAreaLayout);
