 ...
 : BaseParametersWidget(parent)
{
    ...
    connect( stepsEquilSpinBox , static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &ConstrainedParametersWidget::valueChanged );
    connect( stepsEquilExponentSpinBox , static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &ConstrainedParametersWidget::valueChanged );
    connect( stepsProdSpinBox  , static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &ConstrainedParametersWidget::valueChanged );
    connect( stepsProdExponentSpinBox  , static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &ConstrainedParametersWidget::valueChanged );
...
QGroupBox* ConstrainedParametersWidget::createSystemBox()
{
    ...
    ratioSpinBox->setAlignment(Qt::AlignRight);
    ...
    wavelengthSpinBox->setAlignment(Qt::AlignRight);
